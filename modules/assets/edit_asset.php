        ...
        <form action="handle_edit_asset.php" method="POST">
            <input type="hidden" name="asset_id" value="<?php echo $asset['id']; ?>">
             <div class="row">
                ...
                <div class="col-md-6 mb-3"><label for="asset_tag" class="form-label">Asset Tag / Serial Number <span class="text-danger">*</span></label><input type="text" class="form-control" id="asset_tag" name="asset_tag" value="<?php echo htmlspecialchars($asset['asset_tag']); ?>" required></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 mb-3"><label for="purchase_date" class="form-label">Purchase Date</label><input type="date" class="form-control" id="purchase_date" name="purchase_date" value="<?php echo htmlspecialchars($asset['purchase_date']); ?>"></div>
                <div class="col-md-6 mb-3"><label for="purchase_cost" class="form-label">Purchase Cost ($)</label><input type="number" class="form-control" id="purchase_cost" name="purchase_cost" value="<?php echo htmlspecialchars($asset['purchase_cost']); ?>" step="0.01" min="0"></div>
            </div>
            ...
            <div class="mb-3"><label for="notes" class="form-label">Notes</label><textarea class="form-control" id="notes" name="notes" rows="3"><?php echo htmlspecialchars($asset['notes']); ?></textarea></div>
            <hr>
