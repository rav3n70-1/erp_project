            ...
            <fieldset class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" id="useful_life_years" name="useful_life_years" min="0">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="salvage_value" class="form-label">Salvage Value ($)</label>
                        <input type="number" class="form-control" id="salvage_value" name="salvage_value" step="0.01" min="0">
                    </div>
                </div>
            </fieldset>
